        ...
        <div className="container-fluid px-0">
          <div className="text-center mb-5 pb-3">
             <h2 className="display-5 fw-bold section-title">
               Digital cards that work seamlessly <br/> across wallets
             </h2>
          </div>
               ...
               <div className="success-content-box">
                  ...
                  <div className="row g-4">
                    <div className="col-6">
                       ...
                       <p className="stat-label">Faster access to<br/>digital cards</p>
                    </div>
                    <div className="col-6">
                       <h2 className="stat-number">100%</h2>
                       <p className="stat-label">Wallet<br/>compatibility</p>
                    </div>
                  </div>
               </div>
            </div>
      ...
      <div className="process-section py-5 my-5">
        <div className="container-fluid px-0">
          ...
          <div className="text-center mb-5 pb-4">
            ...
            <h2 className="display-5 fw-bold section-title">
              How we turn your card into <br/> a digital experience
            </h2>
          </div>
